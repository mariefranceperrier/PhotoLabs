...
const FavIcon = ({displayAlert, selected}) => {
  return (
    <svg width="30" height="33" viewBox="0 0 24 19" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {
          !!displayAlert &&
        <circle cx="21" cy="4" r="2.75" fill="turquoise" stroke="turquoise" strokeWidth="0.5"/>
      }
    </svg>
  );
};
